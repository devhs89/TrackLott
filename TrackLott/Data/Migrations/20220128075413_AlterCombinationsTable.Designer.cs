...
namespace TrackLott.Data.Migrations
{
    ...
    [Migration("20220128075413_AlterCombinationsTable")]
    partial class AlterCombinationsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrackLott.Models.Ability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TrackLott.Models.Combination", b =>
                {
                    ...
                    b.Property<string>("OptionalNumbers")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("TrackLott.Models.Member", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TrackLott.Models.MemberAbility", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("TrackLott.Models.Ability", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("TrackLott.Models.Member", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TrackLott.Models.Combination", b =>
                {
                    ...
                    b.HasOne("TrackLott.Models.Member", "Member")
                        .WithMany("Combinations")
